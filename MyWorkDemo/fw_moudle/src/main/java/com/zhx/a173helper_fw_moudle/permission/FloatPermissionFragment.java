package com.zhx.a173helper_fw_moudle.permission;
...
import com.zhx.a173helper_fw_moudle.R;
...
public class FloatPermissionFragment extends BasePermissionFragment {
    ...
    @Override
    protected List<String> configPermissions() {
    ...
    protected View createContentView() {
        View mRootView = LayoutInflater.from(getContext()).inflate(R.layout.hepler_layout_permission_landscape_float, null);
    ...
    @Override
    protected void onRetryPermission(List<String> deniedList) {
        LogUtil.e("onRetryPermission ");
    }

    @Override
    protected void onAlwaysDenied(List<String> neverList) {
