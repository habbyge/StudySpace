...
//    public static final String TAG = BasePermissionFragment.class.getSimpleName();
    ...
    protected abstract List<String> configPermissions();
     ...
     * @param deniedList
     */
    protected abstract void onRetryPermission(List<String> deniedList);

    /**
     * 引导至系统 settings页面或直接退出app
     */
    protected abstract void onAlwaysDenied(List<String> neverList);
